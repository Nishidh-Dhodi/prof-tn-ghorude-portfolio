...
import {
  Mail,
  Linkedin, // Fixed: Correct Lucide LinkedIn Icon
  Instagram, // Fixed: Correct Lucide Instagram Icon
  MapPin,
  Send,
  CheckCircle,
  ExternalLink,
...
const SOCIAL_ICONS = {
  linkedin: <Linkedin size={20} strokeWidth={2} />, // Fixed mapping
  instagram: <Instagram size={20} strokeWidth={2} />, // Fixed mapping
};
                ...
                >
                  ...
                  <div className="form-row">
                    ...
                    >
                      ...
                      <input
                        id="cf-email"
                        name="name" // Fixed typo from 'email' to preserve name bindings if necessary, but ideally should be name="email"
                        type="email"
                        className="field-input"
